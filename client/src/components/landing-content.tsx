        ...
        <div className="container mx-auto px-6 lg:px-16 relative z-10">
          <div className="max-w-4xl mx-auto text-center mb-20">
             <div className="inline-flex items-center gap-2 mb-6 px-4 py-1.5 rounded-full bg-white/5 border border-white/10">
                ...
                <span className="text-xs font-medium tracking-widest uppercase text-muted-foreground">Powered by Intelligence</span>
             </div>
             ...
             <p className="text-xl text-muted-foreground/80 font-light leading-relaxed max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
             {[
                ...
                <motion.div 
                  ...
                  className="group p-8 rounded-3xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all hover:border-white/20 hover:shadow-2xl hover:-translate-y-1"
                >
