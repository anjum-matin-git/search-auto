...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/70 backdrop-blur-2xl border-b border-gray-200/50 transition-all duration-300 shadow-lg shadow-black/5">
      <div className="container mx-auto px-6 h-20 flex items-center justify-between">
        <Link href="/" className="font-display font-black text-2xl tracking-tighter flex items-center gap-3 group">
          <div className="w-9 h-9 bg-black text-white rounded-xl flex items-center justify-center shadow-xl shadow-black/30 group-hover:shadow-2xl group-hover:shadow-black/40 transition-all group-hover:scale-105">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path>
            </svg>
          </div>
          <span className="text-black">SearchAuto</span>
        </Link>
        ...
        <div className="flex items-center gap-3">
          {user ? (
            ...
            <>
              ...
              <Link href="/signup">
                <button className="bg-black text-white px-6 py-2.5 rounded-full text-sm font-bold hover:shadow-xl hover:shadow-black/40 hover:bg-gray-900 transition-all hover:scale-105">
                  Sign up
                </button>
              </Link>
            </>
