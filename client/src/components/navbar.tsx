    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/70 backdrop-blur-xl border-b border-gray-200/50 transition-all duration-300 shadow-sm">
      <div className="container mx-auto px-6 h-20 flex items-center justify-between">
        <Link href="/" className="font-display font-bold text-2xl tracking-tight flex items-center gap-2 text-foreground">
          <div className="w-8 h-8 bg-gradient-to-br from-purple-600 to-cyan-600 text-white rounded-lg flex items-center justify-center shadow-lg shadow-purple-500/30">
        ...
        <div className="flex items-center gap-3">
          {user ? (
            ...
            <>
              ...
              <Link href="/signup">
                <button className="bg-gradient-to-r from-purple-600 to-cyan-600 text-white px-5 py-2 rounded-full text-sm font-semibold hover:shadow-lg hover:shadow-purple-500/30 transition-all">
                  Sign up
                </button>
              </Link>
            </>
